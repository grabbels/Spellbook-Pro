import { c as create_ssr_component, b as subscribe, v as validate_component, e as escape, d as add_attribute, f as each, g as null_to_empty, h as set_store_value } from "../../chunks/index2.js";
import "clsx";
import "../../chunks/supabaseClient.js";
import { p as page } from "../../chunks/stores.js";
import { p as pagetitle, s as session, m as modalCall, q as quickQuery, S as Section, a as sidemenuopen, n as notification, t as topmenuopen, b as spellListEmpty, c as bookToEdit, u as userId, d as savePrompt, e as userNickname, l as lookupSpell, f as savedSpellSheets, g as lookupBook } from "../../chunks/stores2.js";
import { B as Button } from "../../chunks/button.js";
import { a as activeSpells, l as loadSpellsheetsByUserId, r as retrieveSession, c as classes, P as Pill, f as firstVisit, b as loggedIn } from "../../chunks/pill.js";
...
const Body = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { style = "" } = $$props;
  if ($$props.class === void 0 && $$bindings.class && classes2 !== void 0)
    $$bindings.class(classes2);
...
let spells = [
  ...
  },
  {
    ...
    ritual: false,
    school: "evocation",
    higer_levels: "At 5th level, the melee attack deals an extra 1d8 thunder damage to the target on a hit, and the damage the target takes for moving increases to 2d8. Both damage rolls increase by 1d8 at 11th level (2d8 and 3d8) and again at 17th level (3d8 and 4d8).",
    tags: ["ranger", "wizard", "level1"],
  ...
  },
  {
    ...
    ritual: false,
    school: "evocation",
    higer_levels: "You extend your hand and point a finger at a target in range. Your magic grants you a brief insight into the target's defenses. On your next turn, you gain advantage on your first attack roll against the target, provided that this spell hasn't ended.",
    tags: ["ranger", "wizard", "level1"],
  ...
  },
  {
    ...
    ritual: false,
    school: "illusion",
    higer_levels: "When you cast this spell using a higher spell slot, you increase the size of the object by 1 foot per spell slot over 1st.",
    tags: ["ranger", "wizard", "level1"],
  ...
  },
  {
    ...
    ritual: false,
    school: "illusion",
    higer_levels: "When you cast this spell using a 3rd- or 4th-level spell slot, the damage increases to 3d8. When you cast it using a 5th- or 6th-level spell slot, the damage increases to 4d8. When you cast it using a spell slot of 7th level or higher, the damage increases to 5d8.",
    tags: ["ranger", "wizard", "level1"],
  ...
  },
  {
    ...
    description: "You teleport yourself to an unoccupied space you can see within range. Immediately after you disappear, a thunderous boom sounds, and each creature within 10 feet of the space you left must make a Constitution saving throw, taking 3d10 thunder damage on a failed save, or half as much damage on a successful one. The thunder can be heard from up to 300 feet away.</p><p>You can bring along objects as long as their weight doesn't exceed what you can carry. You can also teleport one willing creature of your size or smaller who is carrying gear up to its carrying capacity. The creature must be within 5 feet of you when you cast this spell, and there must be an unoccupied space within 5 feet of your destination space for the creature to appear in; otherwise, the creature is left behind.",
    duration: "Instantaneous",
    level: "3",
    name: "Thunder Step",
    range: "90 feet",
    ritual: false,
    school: "conjuration",
    higer_levels: "When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d10 for each slot level above 3rd.",
  ...
  },
  {
    ...
    ritual: false,
    school: "enchantment",
    higer_levels: "This spell's damage increases by 1d6 when you reach certain levels: 5th level (2d6), 11th level (3d6), and 17th level (4d6).",
    tags: ["ranger", "wizard", "level1"],
  ...
  },
  {
    ...
    ritual: false,
    school: "evocation",
    higer_levels: "At 5th level, the melee attack deals an extra 1d8 fire damage to the target on a hit, and the fire damage to the second creature increases to 1d8 + your spellcasting ability modifier. Both damage rolls increase by 1d8 at 11th level (2d8 and 2d8) and 17th level (3d8 and 3d8).",
    tags: ["ranger", "wizard", "level1"],
    type: "Evocation cantrip"
  },
  {
  ...
  },
  {
    ...
    description: "A dazzling array of flashing, colored light springs from your hand. Roll 6d10; the total is how many hit points of creatures this spell can effect. Creatures in a 15-foot cone originating from you are affected in ascending order of their current hit points (ignoring unconscious creatures and creatures that can't see).</p><p>Starting with the creature that has the lowest current hit points, each creature affected by this spell is blinded until the spell ends. Subtract each creature's hit points from the total before moving on to the creature with the next lowest hit points. A creature's hit points must be equal to or less than the remaining total for that creature to be affected.",
    duration: "1 round",
  ...
  },
  {
    ...
    description: "For the duration, you understand the literal meaning of any spoken language that you hear. You also understand any written language that you see, but you must be touching the surface on which the words are written. It takes about 1 minute to read one page of text.</p><p>This spell doesn’t decode secret messages in a text or a glyph, such as an arcane sigil, that isn’t part of a written language.",
    duration: "1 hour",
    level: "1",
  ...
  },
  {
    ...
    description: "You either create or destroy water.</p><p>Create Water: You create up to 10 gallons of clean water within range in an open container. Alternatively, the water falls as rain in a 30-foot cube within range, extinguishing exposed flames in the area.</p><p>Destroy Water: You destroy up to 10 gallons of water in an open container within range. Alternatively, you destroy fog in a 30-foot cube within range.",
    duration: "Instant",
  ...
  },
  {
    ...
    description: "You magically distract the triggering creature and turn its momentary uncertainty into encouragement for another creature. The triggering creature must reroll the d20 and use the lower roll.</p><p>You can then choose a different creature you can see within range (you can choose yourself). The chosen creature has advantage on the next attack roll, ability check, or saving throw it makes within 1 minute. A creature can be empowered by only one use of this spell at a time.</p><p>*which you take when a creature you can see within 60 feet of yourself succeeds on an attack roll, an ability check, or a saving throw",
    duration: "Instant",
    level: "1",
    name: "Silvery Barbs",
    range: "60 feet",
  ...
  },
  {
    ...
    description: "Up to ten berries appear in your hand and are infused with magic for the duration. A creature can use its action to eat one berry. Eating a berry restores 1 hit point, and the berry provides enough nourishment to sustain a creature for a day.</p><p>The berries lose their potency if they have not been consumed within 24 hours of the casting of this spell.",
    duration: "Instant",
    level: "1",
    name: "Goodberry",
    range: "Touch",
  ...
  },
  {
    ...
    description: "Slick grease covers the ground in a 10-foot square centered on a point within range and turns it into difficult terrain for the duration.</p><p>When the grease appears, each creature standing in its area must succeed on a Dexterity saving throw or fall prone. A creature that enters the area or ends its turn there must also succeed on a Dexterity saving throw or fall prone.",
    duration: "1 minute",
    level: "1",
    name: "Grease",
    range: "60 feet",
  ...
  },
  {
    ...
    description: "You choose one object that you must touch throughout the casting of the spell. If it is a magic item or some other magic-imbued object, you learn its properties and how to use them, whether it requires attunement to use, and how many charges it has, if any. You learn whether any spells are affecting the item and what they are. If the item was created by a spell, you learn which spell created it.</p><p>If you instead touch a creature throughout the casting, you learn what spells, if any, are currently affecting it.",
    duration: "Instant",
    level: "1",
    name: "Identify",
    range: "Touch",
  ...
  },
  {
    ...
    description: "You point your finger toward a creature within range and whisper a message. The target (and only the target) hears the message and can reply in a whisper that only you can hear.</p><p>You can cast this spell through solid objects if you are familiar with the target and know it is beyond the barrier. Magical silence, 1 foot of stone, 1 inch of common metal, a thin sheet of lead, or 3 feet of wood blocks the spell. The spell doesn't have to follow a straight line and can travel freely around corners or through openings.",
    duration: "1 round",
    level: "0",
    name: "Message",
    range: "120 feet",
  ...
  },
  {
    ...
    description: "Until the spell ends, one willing creature you touch is protected against certain types of creatures:  aberrations, celestials, elementals, fey, fiends, and undead.</p><p>The protection grants several benefits. Creatures of those types have disadvantage on attack rolls against the target. The target also can't be charmed, frightened, or possessed by them. If the target is already charmed, frightened, or possessed by such a creature, the target has advantage on any new saving throw against the relevant effect.",
    duration: "Concentration, up to 10 minutes",
    level: "1",
  ...
  },
  {
    ...
    description: "This spell sends creatures into a magical slumber. Roll 5d8; the total is how many hit points of creatures this spell can affect. Creatures within 20 feet of a point you choose within range are affected in ascending order of their current hit points (ignoring unconscious creatures).</p><p>Starting with the creature that has the lowest current hit points, each creature affected by this spell falls unconscious until the spell ends, the sleeper takes damage, or someone uses an action to shake or slap the sleeper awake. Subtract each creature’s hit points from the total before moving on to the creature with the next lowest hit points. A creature’s hit points must be equal to or less than the remaining total for that creature to be affected.</p><p>Undead and creatures immune to being charmed aren’t affected by this spell.",
    duration: "1 minute",
  ...
  },
  {
    ...
    description: "This spell creates an invisible, mindless, shapeless force that performs simple tasks at your command until the spell ends. The servant springs into existence in an unoccupied space on the ground within range. It has AC 10, 1 hit point, and a Strength of 2, and it can't attack. If it drops to 0 hit points, the spell ends.</p><p>Once on each of your turns as a bonus action, you can mentally command the servant to move up to 15 feet and interact with an object. The servant can perform simple tasks that a human servant could do, such as fetching things, cleaning, mending, folding clothes, lighting fires, serving food, and pouring wine. Once you give the command, the servant performs the task to the best of its ability until it completes the task, then waits for your next command.</p><p>If you command the servant to perform a task that would move it more than 60 feet away from you, the spell ends.",
    duration: "1 hour",
    level: "1",
    name: "Unseen Servant",
    range: "60 feet",
  ...
  },
  {
    ...
    description: "You project a phantasmal image of a creature’s worst fears. Each creature in a 30-foot cone must succeed on a Wisdom saving throw or drop whatever it is holding and become frightened for the duration.</p><p>While frightened by this spell, a creature must take the Dash action and move away from you by the safest available route on each of its turns, unless there is nowhere to move. If the creature ends its turn in a location where it doesn’t have line of sight to you, the creature can make a Wisdom saving throw. On a successful save, the spell ends for that creature.",
    duration: "Concentration, up to 1 minute",
    level: "3",
    name: "Fear",
  ...
  },
  {
    ...
    description: "Until the spell ends, freezing rain and sleet fall in a 20-foot-tall cylinder with a 40-foot radius centered on a point you choose within range. The area is heavily obscured, and exposed flames in the area are doused.</p><p>The ground in the area is covered with slick ice, making it difficult terrain. When a creature enters the spell’s area for the first time on a turn or starts its turn there, it must make a Dexterity saving throw. On a failed save, it falls prone.</p><p>If a creature is concentrating in the spell’s area, the creature must make a successful Constitution saving throw against your spell save DC or lose concentration.",
    duration: "Concentration, up to 1 minute",
    level: "3",
    name: "Sleet Storm",
    range: "150 feet",
  ...
  },
  {
    ...
    description: "You touch a willing beast. For the duration of the spell, you can use your action to see through the beast’s eyes and hear what it hears, and continue to do so until you use your action to return to your normal senses.</p><p>While perceiving through the beast’s senses, you gain the benefits of any special senses possessed by that creature, though you are blinded and deafened to your own surroundings.",
    duration: "Concentration, up to 1 hour",
    level: "2",
    name: "Beast Sense",
    range: "Touch",
  ...
  },
  {
    ...
    description: "You blast the mind of a creature that you can see within range, attempting to shatter its intellect and personality. The target takes 4d6 psychic damage and must amke an Intelligence saving throw.</p><p>On a failed save, the creature's Intelligence and Charisma scores become 1. The creature can't cast spells, activate magic items, understand language, or communicate in any intelligible way. The creature can, however, identify its friends, follow them, and even protect them.</p><p>At the end of every 30 days, the creature can repeat its saving throw against this spell. If it succeeds on its saving throw, the spell ends.</p><p>The spell can also be ended by [greater restoration], [heal], or [wish].",
    duration: "Instant",
    level: "8",
    name: "Feeblemind",
    range: "150 feet",
  ...
  },
  {
    ...
    description: "You summon a celestial of challenge rating 4 or lower, which apperas in an unoccupied space that you can see within range. The celestial disappears when it drops to 0 hit points or when the spell ends.</p><p>The celestial is friendly to you and your companions for the duration. Roll initiative for the celestial, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you), as long as they don't violate its alignment. If you don't issue any commands to the celestial, it defends itself from hostile creatures but otherwise takes no actions.</p><p>The DM has the celestial's statistics.",
    duration: "Concentration, up to 1 hour",
  ...
  },
  {
    ...
    description: "You utter a divine word, imbued with the power that shaped the world at the dawn of creation. Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points:</p><p>* 50 hit points or fewer: deafened for 1 minute\n* 40 hit points or fewer: deafened and blinded for 10 minutes\n* 30 hit points or fewer: blinded, deafened, and stunned for 1 hour\n* 20 hit points or fewer: killed instantly</p><p>Regardless of its current hit points, a celestial, an element, a fey or a fiend that fails its save is forced back to its plane of origin (if it isn't there already) and can't return to your current plane for 24 hours by any means short of a wish spell.",
    duration: "Instant",
    level: "7",
    name: "Divine Word",
    range: "30 feet",
  ...
  },
  {
    ...
    description: "You send negative engery coursing through a creature that you can see within range, causing it searing pain. The target must make a Constitution saving throw. It takes 7d8 + 30 necrotic damage on a failed save, or half as much damage on a successful one.</p><p>A humanoid killed by this spell rises at the start of your next turn as a zombie that is permanently under your command, following your verbal orders to the best of its ability.",
    duration: "Instant",
    level: "7",
  ...
  },
  {
    ...
    description: `By means of this spell, a willing creature or an object can be hidden away, safe from detection for the duration. When you cast the spell and touch the target, it becomes invisible and can't be targeted by divination spells or perceived through scrying sensors created by divination spells.</p><p>If the target is a creature, it falls into a state of suspended animation. Time ceases to flow for it, and it doesn't grow older.</p><p>You can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target.  Examples include "after 1,000 years" or "when the tarrasque awakens." This spell also ends if the target takes any damage.`,
    duration: "Until dispelled",
    level: "7",
    name: "Sequester",
    range: "Touch",
...
"False destination" is a place that doesn't exist. Perhaps you tried to scry an enemy's sanctum but instead view an illusion, or you were attempting to teleport to a familiar location that no longer exists.</p><p>On Target: You and your group (or the target object) appear where you want to go.</p><p>Off Target: You and your group (or the target object) appear a random distance away from the destination in a random direction. Distance off target is 1d10 x 1d10 percent of the distance that was to be travelled. For example, if you tried to Travel 120 miles, landed off target, and rolled a 5 and 3 on the two d10s, then you would be off target by 15 percent, or 18 miles. The DM determines the direction off target randomly by rolling a d8 and designating 1 as north, 2 as north-east, 3 as east, and so on around the points of the compass. If you were teleporting to a Coastal city and wound up 18 miles out at sea, you could be in trouble.</p><p>Similar Area: You and your group (or the target object) wind up in a different area that's visually or thematically similar to the target area. If you are heading for your home laboratory, for example, you might wind up in another wizard's laboratory or in an alchemical supply shop that has many of the same tools and implements as your laboratory. Generally, you appear in the closest similar place, but since the spell has no range limit, you could conceivably wind up anywhere on the plane.</p><p>Mishap: The spell's unpredictable magic results in a difficult journey. Each teleporting creature (or the target object) takes 3d10 force damage and the DM rerolls on the table to see where you wind up (multiple Mishaps can occur, dealing damage each time).`,
  ...
  },
  {
    ...
    description: "A blast of cold air erupts from your hands. Each creature in a 60-foot cone must make a Constitution saving throw. A creature takes 8d8 cold damage on a failed save, or half as much damage on a successful one.</p><p>A creature killed by this spell becomes a frozen statue until it thaws.",
    duration: "Instant",
    higher_levels: "When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d8 for each slot level above 5th.",
    level: "5",
    name: "Cone of Cold",
  ...
  },
  {
    ...
    description: "Thin and wispy flames wreathe your body for the duration, shedding bright light in a 10-foot radius and dim light for an additional 10 feet, You can end the spell early by using an action to dismiss it.</p><p>The flames provide you with a warm shield or a chill shield, as you choose. The warm shield grants you resistance to cold damage, and the chill shield grants you resistance to fire damage.</p><p>In addition, whenever a creature within 5 feet of you hits you with a melee attack, the shield erupts with flame. The attacker takes 2d8 fire damage from a warm shield, or 2d8 cold damage from a cold shield.",
    duration: "10 minutes",
    level: "4",
    name: "Fire Shield",
    range: "Self",
  ...
  },
  {
    ...
    description: "You touch a corpse or other remains. For the duration, the target is protected from decay and can’t become undead.</p><p>The spell also effectively extends the time limit on raising the target from the dead, since days spent under the influence of this spell don’t count against the time limit of spells such as [raise dead].",
    duration: "10 days",
    level: "2",
    name: "Gentle Repose",
    range: "Touch",
  ...
  },
  {
    ...
    description: "A line of strong wind 60 feet long and 10 feet wide blasts from you in a direction you choose for the spell's duration. Each creature that starts its turn in the line must succeed on a Strength saving throw or be pushed 15 feet away from you in a direction following the line.</p><p>Any creature in the line must spend 2 feet of movement for every 1 foot it moves when moving closer to you.</p><p>The gust disperses gas or vapor, and it extinguishes candles, torches, and similar unprotected flames in the area. It causes protected fiames, such as those of lanterns, to dance wildly and has a 50 percent chance to extinguish them.</p><p>As a bonus action on each of your turns before the spell ends, you can change the direction in which the line blasts from you.",
    duration: "Concentration, up to 1 minute",
    level: "2",
    name: "Gust of Wind",
  ...
  },
  {
    ...
    description: "You become invisible at the same time that an illusory double of you appears where you are standing. The double lasts for the duration, but the invisibility ends if you attack or cast a spell.</p><p>You can use your action to move your illusory double up to twice your speed and make it gesture, speak, and behave in whatever way you choose.</p><p>You can see through its eyes and hear through its ears as if you were located where it is. On each of your turns as a bonus action, you can switch from using its senses to using your own, or back again. While you are using its senses, you are blinded and deafened in regard to your own surrounding.",
    duration: "Concentration, up to 1 hour",
    level: "5",
    name: "Mislead",
    range: "Self",
  ...
  },
  {
    ...
    description: "A Passage appears at a point of your choice that you can see on a wooden, plaster, or stone surface (such as a wall, a ceiling, or a floor) within range, and lasts for the Duration. You choose the opening's dimensions - up to 5 feet wide, 8 feet tall, and 20 feet deep. The Passage creates no instability in a structure surrounding it.</p><p>When the opening disappears, any creatures or objects still in the passage created by the spell are safely ejected to an unoccupied space nearest to the surface on which you cast the spell.",
    duration: "1 hour",
    level: "5",
    name: "Passwall",
    range: "30 feet",
  ...
  },
  {
    ...
    description: "You touch a length of rope that is up to 60 feet long. One end of the rope then rises into the air until the whole rope hangs perpendicular to the ground. At the upper end of the rope, an invisible entrance opens to an extradimensional space that lasts until the spell ends.</p><p>The extradimensional space can be reached by climbing to the top of the rope. The space can hold as many as eight Medium or smaller creatures. The rope can be pulled into the space, making the rope disappear from view outside the space.</p><p>Attacks and spells can't cross through the entrance into or out of the extradimensional space, but those inside can see out of it as if through a 3-foot-by-5-foot window centered on the rope.</p><p>Anything inside the extradimensional space drops out when the spell ends.",
    duration: "1 hour",
    level: "2",
    name: "Rope Trick",
    range: "Touch",
  ...
  },
  {
    ...
    description: "You create three rays of fire and hurl them at targets within range. You can hurl them at one target or several.</p><p>Make a ranged spell attack for each ray. On a hit, the target takes 2d6 fire damage.",
    duration: "Instant",
  ...
  },
  {
    ...
    description: "The ground in a 20-foot radius centered on a point within range twists and sprouts hard spikes and thorns. The area becomes difficult terrain for the duration. When a creature moves into or within the area, it takes 2d4 piercing damage for every 5 feet it travels.</p><p>The transformation of the ground is camouflaged to look natural. Any creature that can't see the area at the time the spell is cast must make a Wisdom (Perception) check against your spell save DC to recognize the terrain as hazardous before entering it.",
    duration: "Concentration, up to 10 minutes",
    level: "2",
    name: "Spike Growth",
    range: "150 feet",
  ...
  },
  {
    ...
    description: "You transmute your quiver so it produces an endless supply of nonmagical ammunition, which seems to leap into your hand when you reach for it.</p><p>On each of your turns until the spell ends, you can use a bonus action to make two attacks with a weapon that uses ammunition from the quiver. Each time you make such a ranged attack, your quiver magically replaces the piece of ammunition you used with a similar piece of nonmagical ammunition. Any pieces of ammunition created by this spell disintegrate when the spell ends. If the quiver leaves your possession, the spell ends.",
    duration: "Concentration, up to 1 minute",
    level: "5",
    name: "Swift Quiver",
    range: "Touch",
  ...
  },
  {
    ...
    description: "You gain the ability to enter a tree and move from inside it to inside another tree of the same kind within 500 feet. Both trees must be living and at least the same size as you. You must use 5 feet of movement to enter a tree. You instantly know the location of all other trees of the same kind within 500 feet and, as part of the move used to enter the tree, can either pass into one of those trees or step out of the tree you're in. You appear in a spot of your choice within 5 feet of the destination tree, using another 5 feet of movement. If you have no movement left, you appear within 5 feet of the tree you entered.</p><p>You can use this transportation ability once per round for the duration. You must end each turn outside a tree.",
    duration: "Concentration, up to 1 minute",
    level: "5",
    name: "Tree Stride",
    range: "Self",
  ...
  },
  {
    ...
    description: "* One Medium or smaller creature that you choose must succeed on a Strength saving throw or be pushed up to 5 feet away from you.</p><p>* You create a small blast of air capable of moving one object that is neither held nor carried and that weighs no more than 5 pounds. The object is pushed up to 10 feet away from you. It isn’t pushed with enough force to cause damage.</p><p>* You create a harmless sensory affect using air, such as causing leaves to rustle, wind to slam shutters shut, or your clothing to ripple in a breeze.",
    duration: "Instant",
    level: "0",
    name: "Gust",
    range: "30 feet",
  ...
  },
  {
    ...
    description: "* You are immune to fire damage and have resistance to cold damage.</p><p>* Any creature that moves within 5 feet of you for the first time on a turn or ends its turn there takes 1d10 fire damage.</p><p>* You can use your action to create a line of fire 15 feet long and 5 feet wide extending from you in a direction you choose. Each creature in the line must make a Dexterity saving throw. A creature takes 4d8 fire damage on a failed save, or half as much damage on a successful one.",
    duration: "Concentration, up to 10 minutes",
    level: "6",
  ...
  },
  {
    ...
    description: "* Ranged weapon attacks made against you have disadvantage on the attack roll.</p><p>* You gain a flying speed of 60 feet. If you are still flying when the spell ends, you fall, unless you can somehow prevent it.</p><p>* You can use your action to create a 15-foot cube of swirling wind centered on a point you can see within 60 feet of you. Each creature in that area must make a Constitution saving throw. A creature takes 2d10 bludgeoning damage on a failed save, or half as much damage on a successful one. If a Large or smaller creature fails the save, that creature is also pushed up to 10 feet away from the center of the cube.",
    duration: "Concentration, up to 10 minutes",
    level: "6",
...
const css$6 = {
  code: "header.svelte-8y76om.svelte-8y76om{margin-top:2rem;width:100%}@media only screen and (max-width: 1024px){header.svelte-8y76om.svelte-8y76om{margin-top:1rem}}header.svelte-8y76om h1.svelte-8y76om{margin-bottom:1rem}@media only screen and (max-width: 1024px){header.svelte-8y76om h1 span.svelte-8y76om{display:block;width:100%}}header.svelte-8y76om .header_inner.svelte-8y76om{display:flex;flex-wrap:wrap;justify-content:space-between;width:100%;align-items:flex-end}header.svelte-8y76om .header_inner .header_right.svelte-8y76om{display:flex;gap:0.4rem}header.svelte-8y76om .header_inner h1.svelte-8y76om{margin-bottom:1rem}header.svelte-8y76om .header_inner input.svelte-8y76om{margin-bottom:0;width:250px;height:46.4px;display:inline-block;border:2px solid transparent}@media only screen and (max-width: 950px){header.svelte-8y76om .header_inner .header_left.svelte-8y76om,header.svelte-8y76om .header_inner .header_right.svelte-8y76om{width:100%;display:grid;grid-template-columns:1fr 1fr;gap:0.5rem}header.svelte-8y76om .header_inner .header_right input.svelte-8y76om{grid-column-start:1;grid-column-end:3;width:100%}}",
  map: null
};
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let $quickQuery, $$unsubscribe_quickQuery;
  ...
  $$unsubscribe_quickQuery = subscribe(quickQuery, (value) => $quickQuery = value);
  $$result.css.add(css$6);
  $$unsubscribe_pagetitle();
  $$unsubscribe_session();
  $$unsubscribe_modalCall();
  $$unsubscribe_quickQuery();
  return `${validate_component(Section, "Section").$$render($$result, { name: "header" }, {}, {
    default: () => {
      return `<header class="${"svelte-8y76om"}">${$pagetitle === "Home" ? `<h1 class="${"svelte-8y76om"}">Inky&#39;s Spellbook <span style="${"margin-left: .2rem;font-size: 1.2rem; opacity: .3;"}" class="${"svelte-8y76om"}">Beta / D&amp;D 5E</span></h1>` : `<h1 class="${"svelte-8y76om"}">${escape($pagetitle)}</h1>`}
		<div class="${"header_inner svelte-8y76om"}"><div class="${"header_left svelte-8y76om"}">${$pagetitle === "Home" ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          href: "",
          type: "fill accent",
        ...
        {}
				...
				${$pagetitle === "Premade spellbooks" || $pagetitle === "My account" ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          text: "Spellbook",
          href: "/",
        ...
        {}
				...
				${$pagetitle == "My account" && $session ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          type: "fill mobile",
        ...
        {}
				...
				${$pagetitle === "Home" || $pagetitle === "My account" ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          href: "/browse",
          type: "fill blue desktop",
        ...
        {}
				...
				${$pagetitle === "Home" ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          href: "",
          type: "fill",
        ...
        {}
			...
			<div class="${"header_right svelte-8y76om"}"><input type="${"text"}" placeholder="${"Quick spell lookup..."}" class="${"svelte-8y76om"}"${add_attribute("value", $quickQuery, 0)}>
				${$session && $pagetitle !== "My account" ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          type: "fill desktop",
        ...
        {},
        {}
      )}` : `${!$session ? `${validate_component(Button, "Button").$$render(
        $$result,
        {
          type: "fill desktop",
          href: "/account/login",
...
const bg = "/_app/immutable/assets/menu-bg-1accf8fc.png";
const addspells_svelte_svelte_type_style_lang = "";
const css$5 = {
  code: '.feedback{width:600px;height:600px;transform:scale(0.2) translateX(-50%);transition:0.4s;opacity:1;border-radius:50vh;background-color:var(--moretranslucent);position:absolute;transform-origin:left}.feedback.animate{opacity:0;transform:scale(1) translateX(-50%)}.sidemenu.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{position:fixed;left:0;top:0;height:100vh;max-width:400px;width:100vw;background-position:top center;background-size:cover;transform:translateX(-100%);transition:transform 0.3s;z-index:3}.sidemenu.open.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{transform:translateX(0%)}.sidemenu.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln:before{position:absolute;content:"";height:100%;width:60px;right:0;top:0;z-index:-1;background:linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.5) 100%)}.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln::-webkit-scrollbar-thumb{background-color:rgba(255, 255, 255, 0.3)}.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln::-webkit-scrollbar-track-piece{background-color:transparent}.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln::-webkit-scrollbar-track{background-color:transparent}.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln::-webkit-scrollbar{width:6px}.wrapper.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{width:100%;height:100%;padding:2rem 1.5rem 2rem 3rem;position:relative}@media only screen and (max-width: 1024px){.wrapper.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{padding:2rem 3vw 1rem;display:grid;grid-template-rows:42px 1fr 46px;grid-gap:0.8rem}}input.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{margin-bottom:0}button.clear.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{background-color:transparent;border:none;padding:0;margin:0;min-height:0;height:auto;position:absolute;top:37px;right:34px;font-size:1.1rem;display:none}button.clear.svelte-1n7dhln i.svelte-1n7dhln.svelte-1n7dhln{font-size:1.1rem;color:var(--lesstranslucent)}button.clear.show.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{display:block}.close_button.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{display:none;width:100%}@media only screen and (max-width: 1024px){.close_button.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{display:block;text-align:center}}ul.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{height:100%;width:100%;margin-top:0.8rem;overflow-x:hidden;overflow-y:auto;position:relative;transition:0.2s;scrollbar-color:rgba(255, 255, 255, 0.3) transparent}@media only screen and (max-width: 1024px){ul.svelte-1n7dhln.svelte-1n7dhln.svelte-1n7dhln{margin-top:0}}ul.svelte-1n7dhln li.svelte-1n7dhln.svelte-1n7dhln{cursor:pointer;position:relative;transition:0.1s}ul.svelte-1n7dhln li.svelte-1n7dhln.svelte-1n7dhln:last-child{margin-bottom:3rem}ul.svelte-1n7dhln li p.svelte-1n7dhln.svelte-1n7dhln{font-weight:400}ul.svelte-1n7dhln li button.svelte-1n7dhln.svelte-1n7dhln{all:unset;box-sizing:border-box;padding:0.35rem 0.8rem 0.5rem;width:100%;height:100%;display:grid;grid-template-columns:40px 1fr;align-items:center;border-bottom:1px solid rgba(255, 255, 255, 0.15);position:relative;overflow:hidden}ul.svelte-1n7dhln li button.svelte-1n7dhln.svelte-1n7dhln:focus{background-color:rgba(255, 255, 255, 0.15)}ul.svelte-1n7dhln li button.svelte-1n7dhln:focus & + i{opacity:1}ul.svelte-1n7dhln li button.svelte-1n7dhln .svelte-1n7dhln{pointer-events:none}ul.svelte-1n7dhln li i.svelte-1n7dhln.svelte-1n7dhln{position:absolute;font-size:1.5rem;color:white;right:0;top:50%;transform:translateY(-50%);transition:0.1s;opacity:0;color:var(--translucent)}@media(pointer: fine){ul.svelte-1n7dhln li:hover button.svelte-1n7dhln.svelte-1n7dhln{background-color:rgba(255, 255, 255, 0.15)}ul.svelte-1n7dhln li:hover i.svelte-1n7dhln.svelte-1n7dhln{opacity:1}}ul.svelte-1n7dhln li.disabled button.svelte-1n7dhln.svelte-1n7dhln{opacity:0.3}',
  map: null
};
const Addspells = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${["sidemenu svelte-1n7dhln", $sidemenuopen ? "open" : ""].join(" ").trim()}" style="${"background-image: url('" + escape(bg, true) + "')"}"><div class="${"wrapper svelte-1n7dhln"}"><input type="${"text"}" id="${"spellsearch"}" placeholder="${"Search for spells..."}" class="${"svelte-1n7dhln"}"${add_attribute("value", query, 0)}${add_attribute("this", searchField, 0)}>
		<button class="${["clear svelte-1n7dhln", ""].join(" ").trim()}"><i class="${"ri-close-circle-fill svelte-1n7dhln"}"></i></button>
		<ul tabindex="${"-1"}" class="${"svelte-1n7dhln"}"${add_attribute("this", resultsList, 0)}>${results.length > 0 ? `${each(results, (spell, i) => {
    return `<li class="${escape(null_to_empty($activeSpells.includes(spell[i]) ? "disabled" : ""), true) + " svelte-1n7dhln"}"><button tabindex="${"0"}" class="${"svelte-1n7dhln"}"${add_attribute("this", result[i], 0)}><div class="${"svelte-1n7dhln"}">${validate_component(Schoolicon, "SchoolIcon").$$render($$result, { school: spell.school }, {}, {})}</div>
							<div class="${"svelte-1n7dhln"}"><h3 class="${"svelte-1n7dhln"}">${escape(spell.name)}</h3>
								<p class="${"svelte-1n7dhln"}">${escape(spell.type)}</p>
								<i class="${"ri-add-line svelte-1n7dhln"}"></i>
							</div></button>
					</li>`;
  })}` : `${query.length > 0 ? `<li class="${"svelte-1n7dhln"}"><button style="${"pointer-events: none"}" class="${"svelte-1n7dhln"}"><div class="${"svelte-1n7dhln"}"></div>
						<div class="${"svelte-1n7dhln"}">
							<p class="${"svelte-1n7dhln"}">No results</p>
							</div></button></li>` : ``}`}</ul>
		<div class="${"close_button svelte-1n7dhln"}">${validate_component(Button, "Button").$$render(
    $$result,
    {
      type: "outline alt",
      text: "close",
...
const bgalt = "/_app/immutable/assets/menu-bg-alt-e4dddd83.png";
const pdf_svelte_svelte_type_style_lang = "";
const topmenu_svelte_svelte_type_style_lang = "";
const css$4 = {
  code: '.topmenu.svelte-cixd.svelte-cixd{background-color:var(--bg);position:relative;width:100vw;background-position:center center;background-size:cover;transform:translateY(-100%);transition:transform 0.3s;position:fixed;top:0;left:0;z-index:3;height:115px}@media only screen and (max-width: 1024px){.topmenu.svelte-cixd.svelte-cixd{height:auto;top:auto;bottom:0;transform:translateY(100%);transition:transform 0.3s}}.topmenu.svelte-cixd .wrapper.svelte-cixd{padding:2rem 2rem 1.3rem;width:100%;display:flex;justify-content:space-between}@media only screen and (max-width: 1024px){.topmenu.svelte-cixd .wrapper.svelte-cixd{flex-wrap:wrap;justify-content:center}.topmenu.svelte-cixd .wrapper .menu_left.svelte-cixd{width:100%;display:grid;max-width:350px}.topmenu.svelte-cixd .wrapper .menu_right.svelte-cixd{width:100%;text-align:center;margin-top:1rem}}.topmenu.svelte-cixd.svelte-cixd:before{position:absolute;content:"";height:60px;width:100%;left:0;bottom:0;background:linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.5) 100%)}.topmenu.open.svelte-cixd.svelte-cixd{transform:translateY(0%)}',
  map: null
};
const Topmenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_pagetitle();
  return `${``}
<div class="${["topmenu svelte-cixd", $topmenuopen ? "open" : ""].join(" ").trim()}" style="${"background-image: url('" + escape(bgalt, true) + "')"}"><div class="${"wrapper svelte-cixd"}"><div class="${"menu_left svelte-cixd"}">
    ...
    {}
		...
		<div class="${"menu_right svelte-cixd"}">
			${validate_component(Button, "Button").$$render(
    $$result,
    {
      type: "outline alt",
...
const css$3 = {
  code: "div.svelte-1jy418w.svelte-1jy418w{position:absolute;right:-0.5rem;top:calc(-41.4px - 0.5rem);width:calc(165.6px + 2.5rem);background-color:var(--translucentdarker);box-shadow:0 3px 10px rgba(0, 0, 0, 0.4);border-radius:6px;-webkit-backdrop-filter:blur(3px);backdrop-filter:blur(3px)}div.svelte-1jy418w form.svelte-1jy418w{display:flex;gap:0.5rem;flex-wrap:wrap;padding:0.5rem}div.svelte-1jy418w form label.svelte-1jy418w{display:inline-block;width:41.4px;aspect-ratio:1/1;border-radius:6px;cursor:pointer}div.svelte-1jy418w form input.svelte-1jy418w{display:none}",
  map: null
};
const Colorpicker = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $bookToEdit, $$unsubscribe_bookToEdit;
  $$unsubscribe_bookToEdit = subscribe(bookToEdit, (value) => $bookToEdit = value);
  ...
  $$unsubscribe_bookToEdit();
  return `<div class="${"color_picker svelte-1jy418w"}"><form class="${"svelte-1jy418w"}">${each(colors, (color) => {
    return `<input type="${"radio"}"${add_attribute("id", color, 0)}${add_attribute("name", color, 0)}${add_attribute("value", color, 0)} class="${"svelte-1jy418w"}"${color === selectedColor ? add_attribute("checked", true, 1) : ""}>
			<label${add_attribute("for", color, 0)} style="${"background-color: " + escape(color, true)}" class="${"svelte-1jy418w"}"></label>`;
  })}</form>
</div>`;
});
const Privacy_policy = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1>Terms and conditions</h1>
<p>Something about email collection and beta software, yada yada.</p>`;
});
const submitspells_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: "label.svelte-72wbnj.svelte-72wbnj.svelte-72wbnj{font-weight:700;display:inline-block;margin-bottom:0.2rem}p.svelte-72wbnj.svelte-72wbnj.svelte-72wbnj{opacity:0.7;margin-top:0}input[type=checkbox].svelte-72wbnj.svelte-72wbnj.svelte-72wbnj{display:inline;width:auto}#classes.svelte-72wbnj.svelte-72wbnj.svelte-72wbnj{display:flex;flex-wrap:wrap}#classes.svelte-72wbnj div.svelte-72wbnj.svelte-72wbnj{margin-right:1rem}#classes.svelte-72wbnj div.svelte-72wbnj input.svelte-72wbnj{margin-right:0.2rem}button.svelte-72wbnj div.svelte-72wbnj.svelte-72wbnj{position:absolute;display:none;animation-name:rotate;animation-iteration-count:infinite;animation-timing-function:linear;animation-duration:0.6s;top:-3px;width:100%;text-align:center;left:0}button.svelte-72wbnj div.loading div.svelte-72wbnj.svelte-72wbnj{display:block}",
  map: null
};
const Submitspells = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_modalCall;
  let $$unsubscribe_notification;
  ...
  $$unsubscribe_notification();
  $$unsubscribe_userId();
  return `<h1>Submit spell</h1>
<p class="${"svelte-72wbnj"}">Thank you for taking the time to make Inky&#39;s Spellbook more complete! It&#39;s quite some information
	to fill in, but if you do so from a credible source you&#39;ll be done in no-time.
</p>
<p class="${"svelte-72wbnj"}">Every spell submission is subject to screening and a submission is no guarantee a spell will make
	it into the database, this all depends on the spell&#39;s credibility and/or community support.
</p>
<form><div class="${"svelte-72wbnj"}"><label for="${"name"}" class="${"svelte-72wbnj"}">Spell name</label>
		<p class="${"svelte-72wbnj"}">Message, Green-Flame Blade, etc.</p>
		<input id="${"name"}" type="${"text"}" name="${"name"}" required placeholder="${"Arcane Missile"}" class="${"svelte-72wbnj"}"${add_attribute("value", name, 0)}></div>

	<div><label for="${"level"}" class="${"svelte-72wbnj"}">Spell level</label>
		<select id="${"level"}" name="${"level"}" required><option value="${"null"}">Select level</option><option value="${"cantrip"}">cantrip</option><option value="${"1"}">level 1</option><option value="${"2"}">level 2</option><option value="${"3"}">level 3</option><option value="${"4"}">level 4</option><option value="${"5"}">level 5</option><option value="${"6"}">level 6</option><option value="${"7"}">level 7</option><option value="${"8"}">level 8</option><option value="${"9"}">level 9</option></select></div>

	<div><label for="${"school"}" class="${"svelte-72wbnj"}">School of magic</label>
		<select id="${"school"}" name="${"school"}" required><option value="${"select"}" disabled>Select school</option><option value="${"conjuration"}">conjuration</option><option value="${"necromancy"}">necromancy</option><option value="${"evocation"}">evocation</option><option value="${"abjuration"}">abjuration</option><option value="${"transmutation"}">transmutation</option><option value="${"divination"}">divination</option><option value="${"enchantment"}">enchantment</option><option value="${"illusion"}">illusion</option></select></div>

	<div class="${"svelte-72wbnj"}"><label for="${"casting_time"}" class="${"svelte-72wbnj"}">Casting time</label>
		<p class="${"svelte-72wbnj"}">1 action, 1 bonus action, 1 reaction, etc.</p>
		<input type="${"text"}" id="${"casting_time"}" name="${"casting_time"}" required placeholder="${"1 action"}" class="${"svelte-72wbnj"}"${add_attribute("value", casting_time, 0)}></div>
	<div class="${"svelte-72wbnj"}"><label for="${"duration"}" class="${"svelte-72wbnj"}">Duration</label>
		<p class="${"svelte-72wbnj"}">1 round, instantaneous, etc.<br>If concentration is required, notate it like &quot;Concentration,
			up to 1 round&quot; or similar.
		</p>
		<input type="${"text"}" id="${"duration"}" name="${"duration"}" required placeholder="${"1 hour"}" class="${"svelte-72wbnj"}"${add_attribute("value", duration, 0)}></div>
	<div class="${"svelte-72wbnj"}"><label for="${"range"}" class="${"svelte-72wbnj"}">Range</label>
		<p class="${"svelte-72wbnj"}">30 feet, Touch, Touch (5-foot radius), etc.</p>
		<input type="${"text"}" id="${"range"}" name="${"range"}" required placeholder="${"30 feet"}" class="${"svelte-72wbnj"}"${add_attribute("value", range, 0)}></div>

	<div><label for="${"description"}" required class="${"svelte-72wbnj"}">Spell description</label>
		<p class="${"svelte-72wbnj"}">Use the official spell description or one from a credible source.</p>
		<textarea name="${"description"}" id="${"description"}" required placeholder="${"You create a healing elixir in a simple vial that appears in your hand."}">${""}</textarea></div>
	<div><label for="${"higher_levels"}" class="${"svelte-72wbnj"}">At higher levels</label>
		<p class="${"svelte-72wbnj"}">If the spell changes when upcast or at higher character levels, mention the description here.
		</p>
		<textarea name="${"higher_levels"}" id="${"higher_levels"}" required placeholder="${"This spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8)..."}">${""}</textarea></div>

	<div><label for="${"save"}" class="${"svelte-72wbnj"}">Defender saving throw</label>
		<select name="${"save"}" id="${"save"}" required><option value="${"null"}">No saving throw</option><option value="${"str"}">Strength</option><option value="${"dex"}">Dexterity</option><option value="${"con"}">Constitution</option><option value="${"wis"}">Wisdom</option><option value="${"int"}">Intelligence</option><option value="${"cha"}">Charisma</option></select></div>
	<div><label for="${"attack"}" class="${"svelte-72wbnj"}">Attack</label>
		<select name="${"attack"}" id="${"attack"}" required><option value="${"null"}">No spell/melee attack</option><option value="${"Ranged spell attack"}">Ranged spell attack</option><option value="${"Melee spell attack"}">Melee spell attack</option><option value="${"Ranged weapon attack"}">Ranged weapon attack</option><option value="${"Melee weapon attack"}">Melee weapon attack</option></select></div>

	<div class="${"svelte-72wbnj"}"><input name="${"ritual"}" id="${"ritual"}" type="${"checkbox"}" class="${"svelte-72wbnj"}"${add_attribute("checked", ritual, 1)}>
		<label for="${"ritual"}" class="${"svelte-72wbnj"}">Ritual?</label></div>

	<div id="${"classes"}" class="${"svelte-72wbnj"}"${add_attribute("this", classes2, 0)}><label style="${"width: 100%"}" for="${"classes"}" class="${"svelte-72wbnj"}">Spell classes</label>
		<p style="${"width: 100%"}" class="${"svelte-72wbnj"}">Which classes can use this spell?</p>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"wizard"}" value="${"wizard"}" class="${"svelte-72wbnj"}"><label for="${"wizard"}" class="${"svelte-72wbnj"}">wizard</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"sorcerer"}" value="${"sorcerer"}" class="${"svelte-72wbnj"}"><label for="${"sorcerer"}" class="${"svelte-72wbnj"}">sorcerer</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"warlock"}" value="${"warlock"}" class="${"svelte-72wbnj"}"><label for="${"warlock"}" class="${"svelte-72wbnj"}">warlock</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"bard"}" value="${"bard"}" class="${"svelte-72wbnj"}"><label for="${"bard"}" class="${"svelte-72wbnj"}">bard</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"cleric"}" value="${"cleric"}" class="${"svelte-72wbnj"}"><label for="${"cleric"}" class="${"svelte-72wbnj"}">cleric</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"druid"}" value="${"druid"}" class="${"svelte-72wbnj"}"><label for="${"druid"}" class="${"svelte-72wbnj"}">druid</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"fighter"}" value="${"fighter"}" class="${"svelte-72wbnj"}"><label for="${"fighter"}" class="${"svelte-72wbnj"}">fighter</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"monk"}" value="${"monk"}" class="${"svelte-72wbnj"}"><label for="${"monk"}" class="${"svelte-72wbnj"}">monk</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"paladin"}" value="${"paladin"}" class="${"svelte-72wbnj"}"><label for="${"paladin"}" class="${"svelte-72wbnj"}">paladin</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"ranger"}" value="${"ranger"}" class="${"svelte-72wbnj"}"><label for="${"ranger"}" class="${"svelte-72wbnj"}">ranger</label></div>
		<div class="${"svelte-72wbnj"}"><input type="${"checkbox"}" id="${"rogue"}" value="${"rogue"}" class="${"svelte-72wbnj"}"><label for="${"rogue"}" class="${"svelte-72wbnj"}">rogue</label></div></div>

	<h3>Components</h3>
	<div class="${"svelte-72wbnj"}"><input name="${"verbal"}" id="${"verbal"}" type="${"checkbox"}" class="${"svelte-72wbnj"}"${add_attribute("checked", verbal, 1)}>
		<label for="${"verbal"}" class="${"svelte-72wbnj"}">Verbal</label></div>
	<div class="${"svelte-72wbnj"}"><input name="${"Somatic"}" id="${"somatic"}" type="${"checkbox"}" class="${"svelte-72wbnj"}"${add_attribute("checked", somatic, 1)}>
		<label for="${"somatic"}" class="${"svelte-72wbnj"}">Somatic</label></div>
	<div class="${"svelte-72wbnj"}"><input name="${"material"}" id="${"material"}" type="${"checkbox"}" class="${"svelte-72wbnj"}"${add_attribute("checked", material, 1)}>
		<label for="${"material"}" class="${"svelte-72wbnj"}">Materials</label>
		<textarea id="${"materials"}" style="${"display: " + escape("none", true)}" name="${"materials"}" placeholder="${"a diamond worth at least 50gp"}">${""}</textarea></div>

	<div><label for="${"source"}" class="${"svelte-72wbnj"}">Source(s)</label>
		<p class="${"svelte-72wbnj"}">Please mention the book (including page number) or URL you sourced this spell from. This is
		...
		<textarea name="${"source"}" id="${"source"}" required>${""}</textarea></div>

	<div class="${"svelte-72wbnj"}"><label for="${"email"}" class="${"svelte-72wbnj"}">Email address</label>
		<p class="${"svelte-72wbnj"}">Leave your email address if you&#39;d like to be informed if and when the spell is included.</p>
		<input type="${"email"}" name="${"email"}" id="${"email"}" class="${"svelte-72wbnj"}"${add_attribute("value", email, 0)}></div>

	<button class="${escape("", true) + " fill accent svelte-72wbnj"}" type="${"submit"}"><i class="${"ri-checkbox-circle-line"}"></i>Submit spell
		<div class="${"svelte-72wbnj"}"><i class="${"ri-loader-5-line"}"></i></div></button>
</form>`;
});
const modal_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ".modal_wrapper.svelte-i9mbts.svelte-i9mbts{position:fixed;left:0;top:0;bottom:0;right:0;background-color:rgba(0, 0, 0, 0.4);-webkit-backdrop-filter:blur(3px);backdrop-filter:blur(3px);z-index:998;display:flex;justify-content:center;align-items:center}.modal_wrapper.svelte-i9mbts .modal.svelte-i9mbts{height:auto;max-height:100vh;width:100%;max-width:800px;box-shadow:0 8px 20px rgba(8, 8, 8, 0.4);background-color:var(--spellbg);border-radius:6px;position:relative}.modal_wrapper.svelte-i9mbts .modal.load .slot.svelte-i9mbts:not(.taken){display:none}.modal_wrapper.svelte-i9mbts .modal .close_modal.svelte-i9mbts{position:fixed;width:100vw;height:100vh;left:0;top:0;z-index:-1}.modal_wrapper.svelte-i9mbts .modal .modal_inner.svelte-i9mbts{height:100%;padding:2rem;position:relative;background-color:var(--spellbg);border-radius:6px;max-height:90vh;overflow-y:auto}@media only screen and (max-width: 1024px){.modal_wrapper.svelte-i9mbts .modal .modal_inner.svelte-i9mbts{max-height:100vh}}.modal_wrapper.svelte-i9mbts .modal .modal_inner .bookmark_decal.svelte-i9mbts{transform:rotate(90deg);position:absolute;left:-47px;z-index:-1;top:0px}.modal_wrapper.svelte-i9mbts .modal .modal_inner .bookmark_decal i.svelte-i9mbts{font-size:5rem;color:var(--yellow)}.modal_wrapper.svelte-i9mbts .modal .modal_inner .save_slots.svelte-i9mbts{display:grid;grid-template-columns:repeat(auto-fill, minmax(150px, 1fr));grid-gap:0.5rem;margin-top:1rem;position:relative;z-index:1}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save.svelte-i9mbts{height:auto;min-height:100%;width:100%;max-height:100%;padding:2rem;border-radius:6px;background-color:var(--spellbg);display:flex;align-items:center;justify-content:center;z-index:1}@media only screen and (max-width: 1024px){.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save.svelte-i9mbts{padding:2rem 0 0}}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form.svelte-i9mbts{max-width:400px}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form .grid.svelte-i9mbts{display:grid;grid-template-columns:1fr 150px;grid-gap:1rem}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form .grid.name-color.svelte-i9mbts{grid-template-columns:1fr 41.4px}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form .grid.name-color input[type=checkbox].svelte-i9mbts{all:unset;cursor:pointer;height:41.4px;width:41.4px;padding:0;margin:0;border:none;display:block;border-radius:6px}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form label.svelte-i9mbts{color:var(--white);margin-bottom:0.25rem;display:inline-block}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form button[type=submit] div.svelte-i9mbts{position:absolute;display:none;animation-name:svelte-i9mbts-rotate;animation-iteration-count:infinite;animation-timing-function:linear;animation-duration:0.6s;top:-3px;width:100%;text-align:center;left:0}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form button[type=submit] div i.svelte-i9mbts{font-size:2rem;color:var(--bg)}@keyframes svelte-i9mbts-rotate{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form button[type=submit].loading.svelte-i9mbts{color:var(--accent)}.modal_wrapper.svelte-i9mbts .modal .modal_inner .new_save form button[type=submit].loading div.svelte-i9mbts{display:block}.modal_wrapper.svelte-i9mbts .modal.lookup.svelte-i9mbts{background-color:rgba(0, 0, 0, 0.5);min-height:0;align-self:flex-start;margin-top:10vh;max-width:600px}@media only screen and (max-width: 1024px){.modal_wrapper.svelte-i9mbts .modal.lookup.svelte-i9mbts{margin-top:0}}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner input.svelte-i9mbts{height:55px;margin:0}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul.svelte-i9mbts{height:100%;width:100%;margin-top:0.8rem;overflow-x:hidden;overflow-y:auto;position:relative;transition:0.2s;max-height:60vh;scrollbar-color:rgba(255, 255, 255, 0.3) transparent}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li.svelte-i9mbts{border-bottom:1px solid rgba(255, 255, 255, 0.15);cursor:pointer;position:relative;transition:0.1s}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li p.svelte-i9mbts{font-weight:400}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li button.svelte-i9mbts{all:unset;padding:0.35rem 0.8rem 0.5rem;width:100%;height:100%;display:grid;grid-template-columns:40px 1fr;align-items:center}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li button.svelte-i9mbts:focus{background-color:rgba(255, 255, 255, 0.15)}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li i.svelte-i9mbts{position:absolute;font-size:1.5rem;color:white;right:0;top:50%;transform:translateY(-50%);transition:0.1s;opacity:0;color:var(--translucent)}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li.svelte-i9mbts:hover{background-color:rgba(255, 255, 255, 0.15)}.modal_wrapper.svelte-i9mbts .modal.lookup .modal_inner ul li.disabled button.svelte-i9mbts{opacity:0.3}.modal_wrapper.svelte-i9mbts .modal.spell.svelte-i9mbts{min-height:0;max-height:100vh;max-width:600px}.card.svelte-i9mbts.svelte-i9mbts{width:100%;cursor:auto}.card.svelte-i9mbts:hover .card_inner.svelte-i9mbts{border-color:var(--accent) !important}.card.svelte-i9mbts .card_inner.svelte-i9mbts{padding:0;box-shadow:none;border-width:0px;pointer-events:unset}.card.svelte-i9mbts .card_inner .block.svelte-i9mbts{pointer-events:unset}.card.svelte-i9mbts .card_inner .block.title h2.svelte-i9mbts{width:100%}.card.svelte-i9mbts .card_inner .block.description.svelte-i9mbts{height:auto}.card.svelte-i9mbts .card_inner .block.description p.svelte-i9mbts{font-size:1rem}.card.svelte-i9mbts .card_inner .block.description.svelte-i9mbts:after{display:none}.card.svelte-i9mbts .card_inner .block.buttons.svelte-i9mbts{margin-top:1rem;display:flex;gap:0.3rem}.card.svelte-i9mbts .card_inner .block.spells.svelte-i9mbts{display:block}.card.svelte-i9mbts .card_inner .block.spells h3.svelte-i9mbts{margin-top:1rem;margin-bottom:-1rem}.card.svelte-i9mbts .card_inner .block.spells p.level.svelte-i9mbts{margin-top:1rem}.card.svelte-i9mbts .card_inner .block.spells ul.svelte-i9mbts{display:grid;grid-template-columns:repeat(auto-fill, minmax(200px, 1fr));gap:0 1rem}.card.svelte-i9mbts .card_inner .block.spells ul li p.svelte-i9mbts{font-size:0.9rem;margin-bottom:0}",
  map: null
};
const Modal = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $modalCall, $$unsubscribe_modalCall;
  let $savePrompt, $$unsubscribe_savePrompt;
  let $bookToEdit, $$unsubscribe_bookToEdit;
  let $$unsubscribe_topmenuopen;
  let $$unsubscribe_notification;
  let $userId, $$unsubscribe_userId;
  let $$unsubscribe_activeSpells;
  let $userNickname, $$unsubscribe_userNickname;
  let $lookupSpell, $$unsubscribe_lookupSpell;
  let $quickQuery, $$unsubscribe_quickQuery;
  let $savedSpellSheets, $$unsubscribe_savedSpellSheets;
  let $session, $$unsubscribe_session;
  let $lookupBook, $$unsubscribe_lookupBook;
  $$unsubscribe_modalCall = subscribe(modalCall, (value) => $modalCall = value);
  $$unsubscribe_savePrompt = subscribe(savePrompt, (value) => $savePrompt = value);
  $$unsubscribe_bookToEdit = subscribe(bookToEdit, (value) => $bookToEdit = value);
  $$unsubscribe_topmenuopen = subscribe(topmenuopen, (value) => value);
  $$unsubscribe_notification = subscribe(notification, (value) => value);
  ...
  $$unsubscribe_lookupSpell = subscribe(lookupSpell, (value) => $lookupSpell = value);
  $$unsubscribe_quickQuery = subscribe(quickQuery, (value) => $quickQuery = value);
  $$unsubscribe_savedSpellSheets = subscribe(savedSpellSheets, (value) => $savedSpellSheets = value);
  $$unsubscribe_session = subscribe(session, (value) => $session = value);
  $$unsubscribe_lookupBook = subscribe(lookupBook, (value) => $lookupBook = value);
  let { modal } = $$props;
  let saveName;
  let saveLevel;
  let saveClass;
  ...
  if ($modalCall == "save" || "load") {
    if (!$userId || !$userNickname) {
      if ($session) {
        set_store_value(userId, $userId = $session.user.id, $userId);
        set_store_value(userNickname, $userNickname = $session.user.user_metadata.nickname, $userNickname);
        loadSpellsheetsByUserId($userId);
      } else {
        let promiseSession = retrieveSession();
        promiseSession.then((value) => {
          if (value) {
            set_store_value(session, $session = value, $session);
            set_store_value(userId, $userId = value.user.id, $userId);
            set_store_value(userNickname, $userNickname = value.user.user_metadata.nickname, $userNickname);
            loadSpellsheetsByUserId($userId);
          }
        });
      }
  ...
  do {
    $$settled = true;
    {
      set_store_value(quickQuery, $quickQuery = "", $quickQuery);
    }
    {
      colorPicker = false, console.log(saveColor);
    }
    {
      if ($quickQuery.length > 0) {
        results = spells.filter((data) => data?.name.toLowerCase()?.includes($quickQuery.toLowerCase()));
      } else {
        results = [];
      }
    }
    $savedSpellSheets.length;
    {
      console.log($modalCall);
    }
    $$rendered = `
${$modalCall ? `<div class="${"modal_wrapper svelte-i9mbts"}"${add_attribute("this", modal, 0)}><div class="${"modal " + escape($modalCall, true) + " svelte-i9mbts"}"><button class="${"close_modal svelte-i9mbts"}"></button>
			${$modalCall !== "lookup" ? `${validate_component(Close, "Close").$$render($$result, {}, {}, {})}` : ``}
			${$modalCall == "welcome" ? `<div class="${"modal_inner svelte-i9mbts"}"><h2 class="${"svelte-i9mbts"}">Welcome!</h2>
					<p class="${"svelte-i9mbts"}">I&#39;m so glad you&#39;re here. Inky&#39;s Spellbook is a project I&#39;ve been working on on and off
					...
					<p class="${"svelte-i9mbts"}">Have a look around, but be warned that there might be scary and dangerous bugs lurking
					...
					<p class="${"svelte-i9mbts"}">Have fun!</p></div>` : `${$modalCall == "save" || $modalCall == "load" || $modalCall == "edit" ? `<div class="${"modal_inner svelte-i9mbts"}">${$modalCall !== "edit" ? `<div class="${"bookmark_decal svelte-i9mbts"}"><i class="${"ri-bookmark-fill svelte-i9mbts"}"></i></div>
						${$savePrompt === false ? `${$modalCall == "save" ? `<h2 class="${"svelte-i9mbts"}">Save slots</h2>
								<p class="${"svelte-i9mbts"}">Select a slot to save your open spellbook in:</p>` : ``}
							${$modalCall == "load" ? `<h2 class="${"svelte-i9mbts"}">Saved spellbooks</h2>
								<p class="${"svelte-i9mbts"}">Select which spellbook you would like to load:</p>` : ``}
							${$savedSpellSheets.length > 0 ? `<div class="${"save_slots svelte-i9mbts"}">${each($savedSpellSheets, (spellsheet) => {
      return `${validate_component(Saveslot, "SaveSlot").$$render($$result, { data: spellsheet }, {}, {})}`;
    })}</div>` : `${validate_component(Loading, "Loading").$$render($$result, {}, {}, {})}`}` : ``}` : ``}
					${$savePrompt === true || $modalCall === "edit" ? `<div class="${"new_save svelte-i9mbts"}"><form class="${"svelte-i9mbts"}"${add_attribute("this", form, 0)}><div class="${"grid name-color svelte-i9mbts"}"><div class="${"svelte-i9mbts"}"><label for="${"name"}" class="${"svelte-i9mbts"}">Spellbook name</label>
										<input${add_attribute("value", $bookToEdit.name ? $bookToEdit.name : "", 0)} name="${"name"}" type="${"text"}" maxlength="${"40"}" class="${"svelte-i9mbts"}"${add_attribute("this", saveName, 0)}></div>
									<div class="${"svelte-i9mbts"}"><label for="${"name"}" class="${"svelte-i9mbts"}">Color</label>
										<input type="${"checkbox"}" name="${"color"}" style="${"background-color: " + escape(saveColor, true)}" class="${"svelte-i9mbts"}">
										
										${colorPicker ? `<div style="${"position: relative"}" class="${"svelte-i9mbts"}">${validate_component(Colorpicker, "Colorpicker").$$render(
      $$result,
      ...
      {}
								...
								<div class="${"grid svelte-i9mbts"}"><div class="${"svelte-i9mbts"}"><label for="${"class"}" class="${"svelte-i9mbts"}">Character class</label>
										
										<select name="${"class"}"${add_attribute("this", saveClass, 0)}><option value="${""}" disabled selected hidden>Select class</option>${each(classes, (dndclass) => {
      return `${$bookToEdit.class == dndclass ? `<option selected${add_attribute("value", dndclass, 0)}>${escape(dndclass)}</option>` : `<option${add_attribute("value", dndclass, 0)}>${escape(dndclass)}</option>`}`;
    })}</select></div>
									<div class="${"svelte-i9mbts"}"><label for="${"level"}" class="${"svelte-i9mbts"}">Character level</label>
										<input name="${"level"}" type="${"number"}" min="${"1"}" max="${"20"}"${add_attribute("value", $bookToEdit.level ? $bookToEdit.level : "", 0)} class="${"svelte-i9mbts"}"${add_attribute("this", saveLevel, 0)}></div></div>
								<label for="${"description"}" class="${"svelte-i9mbts"}">Spellbook description</label>
								<textarea name="${"description"}" style="${"width: 100%"}" rows="${"6"}" maxlength="${"300"}"${add_attribute("this", saveDescription, 0)}>${escape($bookToEdit.description ? $bookToEdit.description : "", true)}</textarea>
								<button class="${escape("", true) + " button fill accent svelte-i9mbts"}" type="${"submit"}"><i class="${"ri-save-3-line svelte-i9mbts"}"></i>Save
									<div class="${"svelte-i9mbts"}"><i class="${"ri-loader-5-line svelte-i9mbts"}"></i></div></button>
								${validate_component(Button, "Button").$$render($$result, { text: "Cancel", type: "fill" }, {}, {})}</form></div>` : ``}</div>` : `${$modalCall == "terms" ? `<div class="${"modal_inner svelte-i9mbts"}">${validate_component(Privacy_policy, "PrivacyPolicy").$$render($$result, {}, {}, {})}</div>` : `${$modalCall == "lookup" ? `<div class="${"modal_inner svelte-i9mbts"}"><input type="${"text"}" placeholder="${"Quick spell lookup..."}" class="${"svelte-i9mbts"}"${add_attribute("this", quickInput, 0)}${add_attribute("value", $quickQuery, 0)}>
					${results ? `<ul tabindex="${"-1"}" class="${"svelte-i9mbts"}">${each(results, (spell, i) => {
      return `<li class="${"svelte-i9mbts"}"><button tabindex="${"0"}" class="${"svelte-i9mbts"}"${add_attribute("this", result[i], 0)}><div class="${"svelte-i9mbts"}">${validate_component(Schoolicon, "SchoolIcon").$$render($$result, { school: spell.school }, {}, {})}</div>
										<div class="${"svelte-i9mbts"}"><h3 class="${"svelte-i9mbts"}">${escape(spell.name)}</h3>
											<p class="${"svelte-i9mbts"}">${escape(spell.type)}</p>
										</div></button>
								</li>`;
    })}</ul>` : ``}</div>` : `${$modalCall == "spell" ? `<div class="${"modal_inner svelte-i9mbts"}"><div${add_attribute("data-name", $lookupSpell.name, 0)} class="${"card item svelte-i9mbts"}"${add_attribute("data-castingtime", $lookupSpell.casting_time, 0)}${add_attribute("data-range", $lookupSpell.range, 0)}><div class="${"card_inner svelte-i9mbts"}"><div class="${"block svelte-i9mbts"}"><h3 class="${"svelte-i9mbts"}">${validate_component(Schoolicon, "SchoolIcon").$$render($$result, { school: $lookupSpell.school }, {}, {})}
									<span style="${"margin-left: .3rem"}">${escape($lookupSpell.name)}</span></h3></div>
							<div class="${"block pills svelte-i9mbts"}">${validate_component(Pill, "Pill").$$render(
      $$result,
      {
        label: "Casting time",
      ...
      {}
								...
								${$lookupSpell.description.toLowerCase().includes("make a ranged spell attack") ? `${validate_component(Pill, "Pill").$$render(
      $$result,
      {
        label: "Spell attack",
      ...
      {},
      {}
    )}` : `${$lookupSpell.description.toLowerCase().includes("make a melee spell attack") ? `${validate_component(Pill, "Pill").$$render(
      $$result,
      {
        label: "Spell attack",
      ...
      {},
      {}
    )}` : `${$lookupSpell.description.toLowerCase().includes("make a spell attack") ? `${validate_component(Pill, "Pill").$$render(
      $$result,
      {
        label: "Spell attack",
        text: "Spell attack",
      ...
      {},
      {}
    )}` : `${$lookupSpell.save ? `${validate_component(Pill, "Pill").$$render(
      $$result,
      {
        label: "Saving throw",
      ...
      {}
							...
							<div class="${"block description svelte-i9mbts"}"><p class="${"svelte-i9mbts"}"><!-- HTML_TAG_START -->${$lookupSpell.description}<!-- HTML_TAG_END --></p></div></div></div></div>` : `${$modalCall == "submitspell" ? `<div class="${"modal_inner svelte-i9mbts"}">${validate_component(Submitspells, "Submitspells").$$render($$result, {}, {}, {})}</div>` : `${$modalCall == "spellbook" ? `<div class="${"modal_inner svelte-i9mbts"}"><div class="${"card svelte-i9mbts"}"><div class="${"card_inner svelte-i9mbts"}"><div class="${"block title svelte-i9mbts"}"><h2 class="${"svelte-i9mbts"}">
									<i style="${"color: " + escape($lookupBook.color, true)}" class="${"ri-book-mark-line svelte-i9mbts"}"></i>
									${escape($lookupBook.name)}</h2>
								<br>
								<p style="${"color: " + escape($lookupBook.color, true)}" class="${"svelte-i9mbts"}">created by <a style="${"color: " + escape($lookupBook.color, true)}" href="${"/"}"><strong>${escape($lookupBook.creator)}</strong></a></p></div>
							<div class="${"block pills svelte-i9mbts"}">${validate_component(Pill, "Pill").$$render(
      $$result,
      {
      ...
      {}
							...
							<div class="${"block description svelte-i9mbts"}"><p class="${"svelte-i9mbts"}"><!-- HTML_TAG_START -->${$lookupBook.description}<!-- HTML_TAG_END --></p></div>
							<div class="${"block buttons svelte-i9mbts"}">${validate_component(Button, "Button").$$render(
      $$result,
      {
        text: "Open",
      ...
      {}
							...
							<div class="${"block spells svelte-i9mbts"}"><h3 class="${"svelte-i9mbts"}">Spells</h3>
								${each(levels, (level, i) => {
      return `<div class="${"svelte-i9mbts"}"${add_attribute("this", levelList[i], 0)}><p class="${"level svelte-i9mbts"}"><strong>${escape(levels[i])}</strong></p>
										<ul class="${"svelte-i9mbts"}">${each($lookupBook.list, (spell) => {
        return `${level.includes(spell.level) || level == "cantrips" && spell.level == 0 ? `<li class="${"svelte-i9mbts"}"><p class="${"svelte-i9mbts"}">${validate_component(Schoolicon, "SchoolIcon").$$render($$result, { type: "small", school: spell.school }, {}, {})} ${escape(spell.name)}</p>
													</li>` : ``}`;
      })}</ul>
									</div>`;
...
const css = {
  code: `@import '../../node_modules/remixicon/fonts/remixicon.css';*,*::before,*::after{box-sizing:border-box}*{margin:0;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}html,body{height:100%}body{line-height:1.5}img,picture,video,canvas,svg{display:block;max-width:100%}input,button,textarea,select{font:inherit}button{background:none;border:none;cursor:pointer}ul{list-style:none;padding:0}p,h1,h2,h3,h4,h5,h6{overflow-wrap:break-word}#root,#__next{isolation:isolate}:root{--black:#000;--white:#fff;--accent:#00cc9d;--primary:#834eb9;--secondary:#fe5a51;--bg:#210e4f;--bg-translucent:rgba(14, 6, 32, 0.7);--grey:#808080;--translucent:rgba(255, 255, 255, 0.3);--moretranslucent:rgba(255, 255, 255, 0.15);--lesstranslucent:rgba(255, 255, 255, 0.6);--translucentdark:rgba(0, 0, 0, 0.2);--translucentdarker:rgba(0, 0, 0, 0.6);--red:#fe5a51;--purple:#834eb9;--lightgreen:#00cc9d;--lightblue:#00aacc;--yellow:#e9ab00;--darkblue:#434be4;--darkgreen:#0f8183;--pink:#ca3cc7;--spellbg:rgb(22, 9, 57);--padding:2rem}@media only screen and (max-width: 1024px){:root{--padding:2vw}}::-webkit-scrollbar-thumb{background-color:rgba(255, 255, 255, 0.3019607843)}*{scrollbar-color:rgba(255, 255, 255, 0.3) rgba(101, 40, 143, 0)}html{scroll-behavior:smooth}body{font-family:"Kanit";margin:0;width:100vw;overflow-x:hidden;height:auto;background-color:var(--primary)}body.noscroll{overflow:hidden}.card{position:relative;cursor:pointer;transition:0.1s}.card .close_veil{z-index:-1;width:100vw;height:100vw;position:fixed;left:0;top:0;background-color:transparent;pointer-events:none}.card .card_inner{pointer-events:none;display:block;border:0;padding:1.3rem 1.9rem;display:flex;flex-wrap:nowrap;flex-direction:column;height:100%;position:relative;box-shadow:0 3px 10px rgba(85, 64, 64, 0.4);border-radius:6px;background-color:var(--spellbg);transition:0.15s;border:2px solid transparent}.card .card_inner h3{margin-bottom:0.1rem}.card .card_inner .block{display:flex;flex-wrap:wrap;position:relative;pointer-events:none;-webkit-user-select:none;-moz-user-select:none;user-select:none}.card .card_inner .block.pills{pointer-events:auto}.card .card_inner .block.description{-webkit-user-select:auto;-moz-user-select:auto;user-select:auto;margin-top:0.5rem;overflow-y:hidden;flex-grow:1;opacity:0.7}.card .card_inner .block.description:after{content:"";position:absolute;bottom:0;left:0;width:100%;height:100px;background:linear-gradient(0deg, rgb(22, 9, 57) 10%, rgba(22, 9, 57, 0) 100%);opacity:1;transition:0.2s}.card.open .card_inner{z-index:2;box-shadow:0 11px 40px rgba(19, 19, 19, 0.5)}.card.open button.close{display:block}.card.open .close_veil{pointer-events:all}.card:hover .card_inner{border-color:var(--accent)}h1,h2,h3{color:var(--white);font-weight:500}a,p,h4,h5{color:var(--white)}h1{font-size:2.1rem}h2{font-size:1.8rem}h3{font-size:1.3rem}p,li{font-size:1rem;font-weight:400;line-height:1.5;margin-bottom:0.5rem;color:var(--white)}label{color:var(--white)}input,select,textarea{width:100%;padding:0.4rem 1rem 0.5rem;font-size:1.1rem;background-color:rgba(255, 255, 255, 0.3);border:0;border-radius:6px;color:white;margin-bottom:1rem;resize:none}input::-moz-placeholder,select::-moz-placeholder,textarea::-moz-placeholder{color:white}input::placeholder,select::placeholder,textarea::placeholder{color:white}.panel{padding:1rem 2rem 2rem;margin-bottom:2rem;border-radius:12px;background-color:var(--moretranslucent);width:100%}@media only screen and (max-width: 1024px){.panel{padding:1rem 1rem 2rem}}.panel h2{margin-bottom:1rem;color:var(--white);margin-left:0.2rem;font-size:1.4rem;opacity:0.3;text-transform:uppercase;font-weight:600}.handle{display:none;position:fixed;border-radius:0 6px 6px 0;left:0;bottom:2rem;z-index:10;background-color:var(--translucent);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);width:60px;height:60px;transition:0.15s}.handle *{pointer-events:none}.handle.filters_handle{bottom:6.5rem}.handle div i{font-size:1.8rem;color:var(--white)}@media only screen and (max-width: 1024px){.handle{display:block}.handle.open{left:-60px}}main.svelte-15jh7ln.svelte-15jh7ln{min-height:100vh}.main_wrapper.svelte-15jh7ln.svelte-15jh7ln{height:100%;width:100%;position:relative;transition:transform 0.3s;background:background 2s;background:linear-gradient(238deg, rgb(101, 40, 143) 0%, rgb(46, 35, 112) 100%);z-index:1}.main_wrapper.svelte-15jh7ln.svelte-15jh7ln::after{content:"";position:absolute;top:0;left:0;width:100%;height:100%;background:linear-gradient(238deg, rgb(62, 35, 112) 0%, rgb(34, 18, 59) 100%);z-index:-1;transition:0.5s;opacity:0}.main_wrapper.svelte-15jh7ln.svelte-15jh7ln::before{content:"";position:absolute;top:0;left:0;width:100%;height:100%;background:linear-gradient(238deg, rgb(77, 35, 112) 0%, rgb(35, 14, 75) 100%);z-index:-1;transition:0.5s;opacity:0}.main_wrapper.browse.svelte-15jh7ln.svelte-15jh7ln::after{opacity:1}.main_wrapper.account.svelte-15jh7ln.svelte-15jh7ln::before{opacity:1}.main_wrapper.svelte-15jh7ln .closemenu.svelte-15jh7ln{position:fixed;left:0;top:0;height:100vh;width:100%;background-color:transparent;display:none;z-index:10}.main_wrapper.sidemenuopen.svelte-15jh7ln.svelte-15jh7ln{transform:translateX(400px)}.main_wrapper.sidemenuopen.svelte-15jh7ln .closemenu.svelte-15jh7ln{display:block}.main_wrapper.topmenuopen.svelte-15jh7ln.svelte-15jh7ln{transform:translateY(115px)}@media only screen and (max-width: 1024px){.main_wrapper.topmenuopen.svelte-15jh7ln.svelte-15jh7ln{transform:translateY(0px)}}.main_wrapper.topmenuopen.svelte-15jh7ln .closemenu.svelte-15jh7ln{display:block}.notification.svelte-15jh7ln.svelte-15jh7ln{position:fixed;bottom:2rem;width:100%;left:0;z-index:999;display:flex;justify-content:center;padding:0;cursor:auto}.notification.svelte-15jh7ln .notification_inner.svelte-15jh7ln{padding:0.8rem 3rem;background-color:var(--white);border-radius:50vh;display:grid;grid-template-columns:34px 1fr;filter:drop-shadow(0 20px 30px rgba(0, 0, 0, 0.6))}.notification.svelte-15jh7ln .notification_inner div.svelte-15jh7ln{display:flex;align-items:center}@media only screen and (max-width: 1024px){.notification.svelte-15jh7ln .notification_inner.svelte-15jh7ln{padding:0.4rem 1rem;margin:0 0.5rem}}.notification.svelte-15jh7ln .notification_inner p.svelte-15jh7ln{text-align:left;color:var(--black);margin-bottom:0}.notification.svelte-15jh7ln .notification_inner p.svelte-15jh7ln a{color:var(--bg);transition:0.1s}.notification.svelte-15jh7ln .notification_inner p.svelte-15jh7ln a:hover{color:var(--accent)}.notification.svelte-15jh7ln .notification_inner i.svelte-15jh7ln{display:none;font-size:1.5rem;vertical-align:-6px}@media only screen and (max-width: 1024px){.notification.svelte-15jh7ln .notification_inner i.svelte-15jh7ln{float:left}}.notification.svelte-15jh7ln .notification_inner.error i.ri-error-warning-fill.svelte-15jh7ln{display:inline;color:var(--secondary)}.notification.svelte-15jh7ln .notification_inner.alert i.ri-alert-fill.svelte-15jh7ln{display:inline;color:var(--yellow)}.notification.svelte-15jh7ln .notification_inner.info i.ri-information-line.svelte-15jh7ln{display:inline;color:var(--lightblue)}.notification.svelte-15jh7ln .notification_inner.positive i.ri-checkbox-circle-line.svelte-15jh7ln{display:inline;color:var(--lightgreen)}`,
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $modalCall, $$unsubscribe_modalCall;
  let $firstVisit, $$unsubscribe_firstVisit;
  let $session, $$unsubscribe_session;
  ...
  let $quickQuery, $$unsubscribe_quickQuery;
  $$unsubscribe_modalCall = subscribe(modalCall, (value) => $modalCall = value);
  $$unsubscribe_firstVisit = subscribe(firstVisit, (value) => $firstVisit = value);
  $$unsubscribe_session = subscribe(session, (value) => $session = value);
  ...
  if ($firstVisit == true) {
    set_store_value(modalCall, $modalCall = "welcome", $modalCall);
    set_store_value(firstVisit, $firstVisit = false, $firstVisit);
  } else {
    set_store_value(modalCall, $modalCall = "", $modalCall);
  }
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  if ($$props.closeMenu === void 0 && $$bindings.closeMenu && closeMenu !== void 0)
    $$bindings.closeMenu(closeMenu);
  $$result.css.add(css);
  let $$settled;
  let $$rendered;
  do {
    ...
    {
      if ($notification) {
        $notification.split("#")[1].includes("info") ? timeOut = 1e4 : 1e4;
        setTimeout(
          () => {
            set_store_value(notification, $notification = "", $notification);
          },
          timeOut
        );
      }
    }
    $$rendered = `${validate_component(Body, "Body").$$render(
      $$result,
      {
...
${validate_component(Topmenu, "TopMenu").$$render($$result, {}, {}, {})}

${validate_component(Addspells, "AddSpells").$$render($$result, {}, {}, {})}



<div class="${[
      "main_wrapper " + escape($page.url.pathname.split("/").pop(), true) + " svelte-15jh7ln",
      ($sidemenuopen ? "sidemenuopen" : "") + " " + ($topmenuopen ? "topmenuopen" : "")
    ].join(" ").trim()}"><main class="${"svelte-15jh7ln"}">${$pagetitle != "Login" && $pagetitle != "Password reset" ? `<div class="${"svelte-15jh7ln"}">${validate_component(Header, "Header").$$render($$result, {}, {}, {})}</div>` : ``}
	...
	<div class="${"closemenu svelte-15jh7ln"}"></div></div>

${$notification ? `<button class="${["notification svelte-15jh7ln", $notification ? "show" : ""].join(" ").trim()}"><div class="${escape(
      $notification.split("#")[1].includes("error") ? "error" : $notification.split("#")[1].includes("alert") ? "alert" : $notification.split("#")[1].includes("positive") ? "positive" : $notification.split("#")[1].includes("info") ? "info" : "",
      true
    ) + " notification_inner svelte-15jh7ln"}"><div class="${"svelte-15jh7ln"}"><i class="${"ri-error-warning-fill svelte-15jh7ln"}"></i><i class="${"ri-alert-fill svelte-15jh7ln"}"></i>
				<i class="${"ri-checkbox-circle-line svelte-15jh7ln"}"></i> <i class="${"ri-information-line svelte-15jh7ln"}"></i></div>
			<div class="${"svelte-15jh7ln"}"><p class="${"svelte-15jh7ln"}"><!-- HTML_TAG_START -->${$notification.split("#")[0]}<!-- HTML_TAG_END --></p></div></div></button>` : ``}

${$modalCall && $modalCall != "lookup" || $modalCall && $quickQuery ? `${validate_component(Modal, "Modal").$$render($$result, {}, {}, {})}` : ``}`;
  } while (!$$settled);
  $$unsubscribe_modalCall();
